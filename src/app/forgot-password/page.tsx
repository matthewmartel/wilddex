        ...
        {sent ? (
          <div className="flex flex-col items-center gap-4 py-8 text-center">
            ...
            <p className="font-sans text-sm text-on-surface-variant leading-relaxed">
              If that email is registered, we&apos;ve sent a reset link. Check your spam folder if it doesn&apos;t arrive within a minute.
            </p>
            <Link
              href="/login"
          ...
          <>
            ...
            {result && result !== "ok" && (
              <div className="bg-error-container border-[3px] border-on-background rounded-lg p-3">
                <p className="font-sans text-sm text-on-error-container">{result}</p>
              </div>
            )}
